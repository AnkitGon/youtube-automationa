...
4. When changing behavior: add/update tests under `tests/` and run them before saying done.
5. If behavior is unclear or risky for the live daemon, ask before changing it.
